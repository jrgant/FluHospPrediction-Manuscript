...
global_date <- "2020-09-19"     # set accordingly
...
In all, we trained 76 component models for each prediction target and within each week of the season. This total includes variations within classes of learners achieved by perturbing various tuning and input parameters (**Table \@ref(tab:candmodels-tuning-table)**). The metalearner was specified using the `sl3` [@Coyle2020-ze] package's implementation of the `solnp` function from the `Rsolnp` package [@Ghalanos2015-sn]. 
